    ...
    <View className="flex-1 bg-gray-950">
      <ScrollView className="flex-1">
        <View className="px-5 pt-14 pb-10">
          ...
          {/* Avatar */}
          <View className="bg-gray-900 rounded-3xl p-6 items-center border border-white/10 mb-4">
          ...
          <View className="flex-row gap-3 mb-4">
            <View className="flex-1 bg-gray-900 rounded-2xl p-4 items-center border border-white/10">
          ...
          <View className="bg-gray-900 rounded-3xl p-5 mb-4 border border-white/10">
            ...
            <View className="flex-row gap-3">
              {(Object.keys(POKEBALL_CONFIG) as PokeballType[]).map(type => {
                ...
                return (
                  <View key={type} className="flex-1 bg-white/5 rounded-2xl p-3 items-center border border-white/10">
          ...
          {/* Accesos rápidos */}
          <View className="bg-gray-900 rounded-3xl border border-white/10 overflow-hidden mb-6">
            {[
