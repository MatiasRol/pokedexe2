      ...
      <ScrollView className="flex-1">
        <View className="px-5 pt-14 pb-10 max-w-md mx-auto w-full">
          ...
          <View className="items-center mb-8">
            ...
            <Text className="text-white text-2xl font-bold capitalize">{session?.name ?? '—'}</Text>
            <Text className="text-white/70 text-sm mt-1">{session?.email ?? '—'}</Text>
          </View>
          ...
          <View className="bg-white/10 rounded-3xl border border-white/20 overflow-hidden mb-6">
            {[
              ...
              <TouchableOpacity
                ...
                className={`flex-row items-center px-5 py-4 gap-3 ${i < arr.length - 1 ? 'border-b border-white/10' : ''}`}
              >
          ...
          <TouchableOpacity
            ...
            className={`py-5 rounded-2xl items-center border-2 ${
              loggingOut ? 'bg-gray-400 border-gray-500' : 'bg-white border-white'
            }`}
          >
